...
const TicTacToe = () => {
	...
	return (
		<div className='h-full w-full overflow-auto'>
			<div
				className='grid place-items-center h-full min-w-[500px]'
				style={{ backgroundImage: `url(${'/images/games/tictactoe.jpg'})`, backgroundSize: 'cover' }}
			>
				<div className='p-10 rounded-2xl bg-slate-100 dark:bg-slate-800 border-2 border-slate-600 opacity-95'>
